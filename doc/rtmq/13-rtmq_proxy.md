# 13 · Proxy 初始化 rtmq_proxy

> **源文件**：`src/clang/lib/rtmq/proxy/rtmq_proxy.c`  
> **模块**：Proxy 初始化 rtmq_proxy  
> **说明**：proxy_init/launch/reg_add/async_send：业务进程发消息到 Server。  
...
> **层级**：Proxy · API  
> **在 RTMQ 中的位置**：业务进程发消息的入口：reg_add + async_send 入 sendq  
> **总地图**：[00-总地图.md](00-总地图.md) · 上一篇 `05-rtmq_proxy_h` · 下一篇 `14-rtmq_proxy_tsvr_part1`
...
| 函数 | 约略位置 |
|------|----------|
| `rtmq_proxy_creat_send_cmd_fd` | 见下方代码块 |
| `rtmq_proxy_creat_work_cmd_fd` | 见下方代码块 |
| `rtmq_proxy_cmd_work_chan_init` | 见下方代码块 |
| `rtmq_proxy_conf_isvalid` | 见下方代码块 |
| `rtmq_proxy_creat_workers` | 见下方代码块 |
| `rtmq_proxy_creat_work_cmd_fd` | 见下方代码块 |
| `rtmq_proxy_tsvr_init_cb` | 见下方代码块 |
| `rtmq_proxy_creat_send_cmd_fd` | 见下方代码块 |
| `rtmq_proxy_creat_senders` | 见下方代码块 |
| `rtmq_proxy_creat_recvq` | 见下方代码块 |
| `rtmq_proxy_creat_sendq` | 见下方代码块 |
| `rtmq_proxy_init` | 见下方代码块 |
| `rtmq_proxy_launch` | 见下方代码块 |
| `rtmq_proxy_reg_add` | 见下方代码块 |
| `rtmq_proxy_cmd_send_req` | 见下方代码块 |
...
```c
// 文件: src/clang/lib/rtmq/proxy/rtmq_proxy.c
#include "comm.h"
#include "lock.h"
#include "redo.h"
#include "syscall.h"
