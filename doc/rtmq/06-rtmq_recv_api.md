# 06 · Server 初始化与对外 API

> **源文件**：`src/clang/lib/rtmq/server/rtmq_recv.c`  
> **模块**：Server 初始化与对外 API  
> **说明**：rtmq_init/launch/register/publish/async_send 及队列、线程池创建。Server 端大脑。  
...
> **层级**：Server · API  
> **在 RTMQ 中的位置**：Server 对外四接口：init/launch/register/publish/async_send  
> **总地图**：[00-总地图.md](00-总地图.md) · 上一篇 `04-rtmq_sub_and_recv_h` · 下一篇 `07-rtmq_lsn`
...
| 函数 | 约略位置 |
|------|----------|
| `rtmq_auth_init` | 见下方代码块 |
| `rtmq_creat_connq` | 见下方代码块 |
| `rtmq_creat_recvq` | 见下方代码块 |
| `rtmq_creat_sendq` | 见下方代码块 |
| `rtmq_creat_distq` | 见下方代码块 |
| `rtmq_creat_recv_cmd_fd` | 见下方代码块 |
| `rtmq_creat_work_cmd_fd` | 见下方代码块 |
| `rtmq_creat_dist_cmd_fd` | 见下方代码块 |
| `rtmq_cmd_send_dist_req` | 见下方代码块 |
| `rtmq_creat_recvs` | 见下方代码块 |
| `rtmq_recvs_destroy` | 见下方代码块 |
| `rtmq_creat_workers` | 见下方代码块 |
| `rtmq_workers_destroy` | 见下方代码块 |
| `rtmq_proc_def_hdl` | 见下方代码块 |
| `rtmq_pub_group_trav_cb` | 见下方代码块 |
| `rtmq_init` | 见下方代码块 |
| `rtmq_launch` | 见下方代码块 |
...
```c
// 文件: src/clang/lib/rtmq/server/rtmq_recv.c
/******************************************************************************
...
/* ===== 阅读注释：rtmq_pub_group_trav_cb =====
 * 【publish 遍历】对每个订阅 gid 组内的连接复制一份 payload 发送。
 */
