...
> **源文件**：`src/clang/incl/rtmq/rtmq_comm.h`  
> **模块**：公共类型 rtmq_comm  
> **说明**：错误码、收发快照 rtmq_snap_t、worker 结构、Register 回调类型 rtmq_reg_cb_t。  
...
> **层级**：协议层  
> **在 RTMQ 中的位置**：Server/Proxy 共用的类型：错误码、snap 缓冲、reg 回调签名  
> **总地图**：[00-总地图.md](00-总地图.md) · 上一篇 `02-rtmq_mesg` · 下一篇 `04-rtmq_sub_and_recv_h`
...
```c
// 文件: src/clang/incl/rtmq/rtmq_comm.h
